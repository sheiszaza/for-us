...
import { Heart, LogOut, Palette, Shield } from 'lucide-react';
...
export function Settings() {
  ...
  return (
    <Page eyebrow="Private controls" title="Settings" description="Update your local PIN and keep the app feeling personal.">
      <Card>
